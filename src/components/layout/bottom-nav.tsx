...
const navItems = [
  ...
  { href: "/daily", label: "아침 기록", icon: SunIcon },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-t border-border safe-area-bottom">
